...
# c("disease","medulloblastoma","other", "glioma"))
...
# takes 1 min
system.time(resLFC <- lfcShrink(dds, coef=paste0("simplified_disease_other_vs_", this_disease), type="apeglm", parallel=TRUE, BPPARAM=MulticoreParam(4)))
...
sum(resLFC$padj < 0.05*1e-100, na.rm=TRUE)
