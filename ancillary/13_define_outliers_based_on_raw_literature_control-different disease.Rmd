...
this_truth_definition <-  "outlier_present_in_shifted_literature"# "outlier_present_in_literature"
...
parent_metadata %>% select(Disease, Eval_ID)
...
annotated_outlier_results <- lapply(unique(outlier_results_raw$parent_sample), function(this_parent_sample) {
  ...
  if (this_truth_definition == "outlier_present_in_shifted_literature") {
    ...
    true_outliers_in_parent_sample <- outlier_results %>%
